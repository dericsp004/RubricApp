...
public class GradingActivity extends AppCompatActivity {
    ...
    public void calcGrade() {
        int total = 0;
        int achieved = 0;
        //TODO: get only selected criteria's point values into a list
        //Note that unselected points do not count towards the total available points

        float grade = achieved / total;
